...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-info">Student Update </div>
            ...
            <label for="lastname" class="col-md-4 col-form-label text-md-right">{{ __('LastName') }}</label>
                                ...
                                <div class="col-md-6">
         <input id="lastname" type="text" class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" name="lastname" value="{{$student->lastname}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="firstname" type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" name="firstname" value="{{$student->firstname}}" required autofocus>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="middlename" type="text" class="form-control{{ $errors->has('middlename') ? ' is-invalid' : '' }}" name="middlename" value="{{ $student->middlename}}"  autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="studentid" type="text" class="form-control{{ $errors->has('studentid') ? ' is-invalid' : '' }}" name="studentid" value="{{ $student->studentid }}">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ $student->phone }}" autofocus>
        ...
        <label for="dateofbirth" class="col-md-4 col-form-label text-md-right">{{ __('Date Of Birth') }}</label>
                ...
                <div class="col-md-6">
         <input id="dateofbirth" type="date"  max="60" class="form-control" name="dateofbirth" value="{{ $student->dateofbirth }}" autofocus>
...
<div class="form-group row">
        <label for="paymentstatus" class="col-md-4 col-form-label text-md-right">{{ __('Payment Status') }}</label>
                     ...
                     <select class="form-control" id="paymentstatus" name="paymentstatus">
                      <option value="{{ $student->paymentstatus }}">{{ old('relgion') }}</option>
             ...
             <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="paymentrate" type="text" class="form-control{{ $errors->has('paymentrate') ? ' is-invalid' : '' }}" name="paymentrate" value="{{ $student->paymentrate }}"  autofocus>
...
<select class="form-control" id="status" name="status" required>
                                    <option value="{{ $student->status }}">{{ $student->status== 1 ? 'Active' : 'Not Active' }}</option>
                                                 <option value="0">De-Activate Current</option>
                ...
                <label for="stateoforigin" class="col-md-4 col-form-label text-md-right">{{ __('State Of Origin') }}</label>
                   ...
                   @endif
                           ...
                           <div class="form-group row">
                                   ...
                                   <div class="col-md-6">
                                       <input id="province" type="text" class="form-control{{ $errors->has('province') ? ' is-invalid' : '' }}" name="province" value="{{ $student->province }}" autofocus>
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="plastname" type="text" class="form-control{{ $errors->has('plastname') ? ' is-invalid' : '' }}" name="plastname" value="{{ $student->plastname }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pfirstname" type="text" class="form-control{{ $errors->has('pfirstname') ? ' is-invalid' : '' }}" name="pfirstname" value="{{ $student->pfirstname }}" required autofocus>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="pmiddlename" type="text" class="form-control{{ $errors->has('pmiddlename') ? ' is-invalid' : '' }}" name="pmiddlename" value="{{ $student->pmiddlename }}"  autofocus>
                               ...
                               <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="partnername" type="text" class="form-control{{ $errors->has('partnername') ? ' is-invalid' : '' }}" name="partnername" value="{{ $student->partnername }}"  autofocus>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="relationship" type="textarea" class="form-control{{ $errors->has('relationship') ? ' is-invalid' : '' }}" name="relationship" value="{{ $student->relationship }}"  autofocus>
                           ...
                           <input id="male" type="radio" name="maritalstatus" value="Male" {{ (old('maritalstatus') == 'married') ? 'checked' : '' }} >Married
                               ...
                               @endif
                                   ...
                                   <div class="form-group row">
                                           ...
                                           <div class="col-md-6">
                                               <input id="address" type="textarea" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{ $student->address }}"  autofocus>
                                       ...
                                       <div class="form-group row">
                                               ...
                                               <div class="col-md-6">
                                                   <input id="passport" type="file" class="form-control{{ $errors->has('passport') ? ' is-invalid' : '' }}" name="passport" value="{{ $student->passport }}"  autofocus>
