...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-info">Teacher Update </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('teachers.update', $teacher->id) }}">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="lastname" type="text" class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" name="lastname" value="{{$teacher->lastname}}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="firstname" type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" name="firstname" value="{{$teacher->firstname}}" required autofocus>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="middlename" type="text" class="form-control{{ $errors->has('middlename') ? ' is-invalid' : '' }}" name="middlename" value="{{$teacher->middlename}}"  autofocus>
                 ...
                 <div class="col-md-6">
                <input id="staffidno" type="text" class="form-control{{ $errors->has('staffidno') ? ' is-invalid' : '' }}" name="staffidno" value="{{$teacher->staffidno}}">
                 ...
                 <span class="invalid-feedback">
                    <strong>{{ $errors->first('staffidno') }}</strong>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{$teacher->phone}}" autofocus>
                        ...
                        <div class="form-group row">
                                         ...
                                         <div class="col-md-6">
                                         <input id="dateofbirth" type="text"  max="90" class="form-control" name="dateofbirth" value="{{$teacher->dateofbirth}}" autofocus>
         ...
         <div class="col-md-6">
        <input id="dateemployed" type="date" max="60" class="form-control" name="dateemployed" value="{{$teacher->dateemployed}}}" autofocus>
               ...
               <input id="male" type="radio" name="maritalstatus" value="Male" {{ (old('maritalstatus') == 'married') ? 'checked' : '' }} >Married
                   ...
                   <div class="form-group row">
                           ...
                           <div class="col-md-6">
                               <input id="qualification" type="text" class="form-control{{ $errors->has('qualification') ? ' is-invalid' : '' }}" name="qualification" value="{{$teacher->qualification}}"  autofocus>
                   ...
                   <div class="col-md-6">
                       <div class="form-group">
                             ...
                             <select class="form-control" id="country" name="country">
                               <option value="{{$teacher->country}}">{{$teacher->country}}</option>
         ...
         <!--occupation -->
                ...
                <label for="stateoforigin" class="col-md-4 col-form-label text-md-right">{{ __('State Of Origin') }}</label>
                           ...
                           <div class="col-md-6">
                             ...
                             <option value="{{$teacher->stateoforigin}}">{{$teacher->stateoforigin}}</option>
                   ...
                   @endif
                           ...
                           <div class="form-group row">
                                   ...
                                   <div class="col-md-6">
                                       <input id="province" type="text" class="form-control{{ $errors->has('province') ? ' is-invalid' : '' }}" name="province" value="{{$teacher->province}}" required autofocus>
                               ...
                               <div class="form-group row">
                                       ...
                                       <div class="col-md-6">
                                           <input id="duty" type="textarea" class="form-control{{ $errors->has('duty') ? ' is-invalid' : '' }}" name="duty" value="{{$teacher->duty}}"  autofocus>
                                   ...
                                   <div class="form-group row">
                                           ...
                                           <div class="col-md-6">
                                               <input id="address" type="textarea" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" value="{{$teacher->address}}"  autofocus>
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                       ...
                                       <div class="form-group row">
                                               ...
                                               <div class="col-md-6">
                                                   <input id="passport" type="file" class="form-control{{ $errors->has('passport') ? ' is-invalid' : '' }}" name="passport" value="{{$teacher->passport}}"  autofocus>
